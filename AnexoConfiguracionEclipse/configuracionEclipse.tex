...
\markboth{ANEXO \ref{cap:apendiceA}. CONFIGURACIÓN DE ECLIPSE.}{}
...
\begin{figure}[hbt]
  \centering
    \includegraphics[scale=0.4]{./AnexoConfiguracionEclipse/imagenes/androidSDK.png}
...
\begin{figure}
  \centering
    \includegraphics[scale=0.6]{./AnexoConfiguracionEclipse/imagenes/licencias.png}
...
\begin{figure}[hbt]
  \centering
    \includegraphics[scale=0.4]{./AnexoConfiguracionEclipse/imagenes/GAESettings.png}
